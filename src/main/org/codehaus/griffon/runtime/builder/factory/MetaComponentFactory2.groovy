 ...
 */
class MetaComponentFactory2 extends AbstractFactory {
    ...
    void setChild(FactoryBuilderSupport builder, Object parent, Object child) {
        invokeClosureOrMethod(builder.parentContext.mvcGroup.controller, 'setChild', builder, parent, child)
    }

    @Override
    void setParent(FactoryBuilderSupport builder, Object parent, Object child) {
        invokeClosureOrMethod(builder.context.mvcGroup.controller, 'setParent', builder, parent, child)
    }

    @Override
    void onNodeCompleted(FactoryBuilderSupport builder, Object parent, Object node) {
        invokeClosureOrMethod(builder.context.mvcGroup.controller, 'onNodeCompleted', builder, parent, node)
    }

    static protected def invokeClosureOrMethod(Object obj, String method, Object... args) {
        try {
